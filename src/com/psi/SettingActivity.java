	...
	private OnClickListener btOkListener = new OnClickListener() {
		...
		public void onClick(View view) {
			...
			if (null != errorMessage) {
				new AlertDialog.Builder(SettingActivity.this).setTitle(getString(R.string.setting_title)).setMessage(errorMessage).setIcon(android.R.drawable.ic_dialog_alert).setNegativeButton(getString(R.string.bt_ok), new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialog, int whichButton) {
						dialog.cancel();
					}
				}).show();
