...
public class CalendarUtil {
 ...
 private int[] madd = new int[] { 0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334 };
 ...
 public static void main(String[] args) {
  CalendarUtil lunnar = new CalendarUtil();
  try {
   //lunnar.e2c("1981年11月20日");
   lunnar.e2c("1940年07月17日");
